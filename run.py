...
parser.add_argument("--dataset", default="mnist", help="mnist | fmnist")
...
parser.add_argument("--mu_epochs", default=500, type=int, help="number of training epochs (decoder mu)")
parser.add_argument("--sigma_epochs", default=500, type=int, help="number of training epochs (decoder sigma)")
parser.add_argument("--prior_epochs", default=500, type=int, help="number of training epochs (prior/KL)")
...
parser.add_argument("--num_components", default=10, type=int, help="number of components for the prior")
